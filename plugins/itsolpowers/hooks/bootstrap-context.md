...
9. Use subagents for independent implementation/review surfaces when available. For large or multi-surface code review, run focused subagents by risk area before the final verdict.
