...
9. Finish every extension-managed task through `itsol_complete` with exact `done_when` evidence, the achieved stop stage, review evidence, and honest unverified gaps. After the gate, use the forced tool-free turn to give the user a concise final summary of the result, achievements, key findings or lessons, verification, and remaining gaps.
