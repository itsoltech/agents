...
- Frontend and desktop: `react-nextjs-*`, `tanstack-query-react-nextjs-*`, `svelte-*`, `tanstack-query-svelte-*`, `electron-*`, `tauri-*`, `hey-api-openapi-*`.
