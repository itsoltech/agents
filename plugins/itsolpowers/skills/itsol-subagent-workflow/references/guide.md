# ITSOL Subagent Workflow Reference Reference Index
...
Subagent execution workflow: task split, parallelism, delegation, review loop, commit discipline, validation and user summary.
