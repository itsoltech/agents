...
13. Before writing the Technical Plan, run a Technical Decision Gate: inspect repo constraints, verify current technology context when relevant, present feasible technical approaches with tradeoffs, recommend one, and ask the user to choose or approve the approach.
