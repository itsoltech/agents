...
Resolve the workflow mode before applying planning or implementation gates. Treat this skill as the canonical contract; downstream skills must not redefine different mode semantics.
