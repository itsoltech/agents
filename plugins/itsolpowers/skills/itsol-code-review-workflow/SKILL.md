...
6. Delegate focused review subagents by changed surface and risk dimension, for example current technology context, security, infrastructure, frontend, backend, database, generated API clients, migration/rewrite, QA/release, performance, or test strategy. Use the narrowest ITSOL skill/subagent that matches each area.
