...
2. Check review priorities in order: scope and acceptance criteria, correctness, security, architecture, data, errors, TDD/test evidence, performance, observability, maintainability, then style.
