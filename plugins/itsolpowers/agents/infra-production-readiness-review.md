...
2. If the preloaded skill is missing, read `${CLAUDE_PLUGIN_ROOT}/skills/infra-production-readiness-review/SKILL.md` and follow its [references/guide.md](${CLAUDE_PLUGIN_ROOT}/skills/infra-production-readiness-review/references/guide.md) instructions.
